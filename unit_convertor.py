...
#mariam
"mariam":"I swear, this girl is running a whole printing press and IT service from the back of the class. 🖨️😂 She talks so slowly that by the time she finishes a sentence, the semester is almost over. 🐢 But don’t be fooled by her quiet nature—when it comes to programming and computer assignments, she’s on beast mode. 💻🔥Need a printout? Photocopy? A book? She’s already got it sorted before you even ask. 📚 She’s like a background app always running—silent but essential. While the rest of us are losing our minds over deadlines, she’s just there, calmly doing her thing, completely disconnected from the chaos. 😂 A true lifesaver, but good luck trying to get her into a gossip session—she’s too busy being the class’s secret tech wizard. 🚀"
